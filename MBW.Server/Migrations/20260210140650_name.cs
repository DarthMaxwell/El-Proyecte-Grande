    ...
    public partial class name : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Two imprisoned men bond over a number of years, finding solace and eventual redemption through acts of common decency. Andy Dufresne, a banker wrongly convicted of murder, befriends fellow lifer Red while maintaining his innocence and dignity.", "Frank Darabont", "Drama", 142, new DateOnly(1994, 10, 14), "The Shawshank Redemption" },
                    { 2, "The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son. Michael Corleone is drawn deeper into the family business, transforming from war hero to ruthless mob boss in this epic tale of power, loyalty, and corruption.", "Francis Ford Coppola", "Crime", 175, new DateOnly(1972, 3, 24), "The Godfather" },
                    { 3, "Batman faces the Joker in Gotham City as the Clown Prince of Crime unleashes chaos and forces the Dark Knight to confront his own moral limits. Heath Ledger delivers an unforgettable performance as the anarchic villain who seeks to prove that anyone can be corrupted.", "Christopher Nolan", "Action", 152, new DateOnly(2008, 7, 18), "The Dark Knight" },
                    { 4, "The life journey of a kind-hearted man with below-average intelligence who witnesses and influences several defining historical events in 20th century America. Despite his limitations, Forrest's genuine nature and unwavering love for Jenny carry him through an extraordinary life.", "Robert Zemeckis", "Drama", 154, new DateOnly(1994, 7, 6), "Forrest Gump" },
                    { 5, "A skilled thief who enters dreams to steal corporate secrets is given the inverse task of planting an idea into the mind of a CEO. Dom Cobb must navigate multiple layers of dreams within dreams, where the laws of physics bend and time dilates, while confronting his own guilt-ridden subconscious.", "Christopher Nolan", "Sci-Fi", 148, new DateOnly(2010, 7, 16), "Inception" },
                    { 6, "A computer hacker discovers that reality as he knows it is actually a simulated construct created by sentient machines to pacify humanity while using their bodies as an energy source. Neo must choose between the comfortable lie of the Matrix and the harsh truth of the real world.", "Lana Wachowski, Lilly Wachowski", "Sci-Fi", 136, new DateOnly(1999, 3, 31), "The Matrix" },
